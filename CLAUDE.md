...
Docs: `docs/GDD.md` (game design), `docs/TechnicalDesign.md` (architecture), `docs/BoardGeneration.md` (generator algorithm), `docs/TODO.md` (tracked bugs and pending decisions).
